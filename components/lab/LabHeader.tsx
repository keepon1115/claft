  ...
  return (
    <header className="lab-header">
      ...
      <div className="lab-header-icons">
        ...
        <Link href="/lab/guide" className="lab-icon-btn" aria-label="アプリの使い方" data-tour="guide">
          <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <Link href="/lab/idea" className="lab-icon-btn" aria-label="アイデア箱" data-tour="idea">
          <svg viewBox="0 0 24 24" aria-hidden="true">
