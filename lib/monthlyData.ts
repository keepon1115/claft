...
export const issues: Issue[] = [
  {
    ...
    coverSubtitle: '創って伝える、毎月の記録 / 2026年5月号 Vol.2',
    features: [
      {
        id: 'recap',
        category: 'イベント振り返り',
      ...
      },
      {
        ...
        announcements: [
          ...
          },
          {
            ...
            link: { label: 'Yononaka（世の中探究）を見る', href: '/yononaka', external: false },
          },
          {
  ...
  },
  {
    ...
    coverTitle: 'KEEPON JOURNAL',
    coverSubtitle: '創って伝える、毎月の記録 / 2026年6月号 Vol.3',
    features: [
      {
        id: 'recap',
        category: 'イベント振り返り',
      ...
      },
      {
        ...
        category: 'ロボットニュース',
        title: '農業ロボット「新ボ」',
        lead: '今月のロボットニュースは農業ロボット「新ボ」。日本の農業は担い手不足と高齢化が進み、暑さ・雨風の中での重労働という課題があります。新ボはAIとカメラを搭載し、レタスの間の雑草をピンポイントで抜いたり、水を与えたり、土や作物の状態を見て自分でやるべき作業を判断します。畑に置いておけば作業をこなしてくれる——その将来性に投資家から資金が集まったことがニュースに。人が大変・危ない仕事にロボットを入れれば、もっと便利な世界がつくれる。その視点をぜひ持ってほしい。',
        dialogues: [
          {
            speaker: 'shoichiro',
      ...
      },
      {
        ...
        subAnnouncements: [
          ...
          {
            body: '7月の世の中探究はURC（ロボット国際協議会）テーマ＝SDGs 8番「働きがいも経済成長も」と絡めた内容。',
          },
        ],
      },
    ],
